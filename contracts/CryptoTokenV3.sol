...
contract CryptoTokenV3 is PullPayment, ERC20Interface {
    ...
    function CryptoTokenV3(address previousContractAddress) public {
    ...
    function becomeMember() payable whenNotPaused external returns (uint256 share) {
        require(msg.value > 0.05 ether);
        uint maxShare = 500 ether;
        share = maxShare.div(msg.value);
